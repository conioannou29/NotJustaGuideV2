...
public class FoodActivityV2 extends AppCompatActivity {
    ...
    private static final String TAG = "FoodActivityV2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new JSONAsyncTask().execute("https://api.myjson.com/bins/fmqhb");
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(FoodActivityV2.this);
        ...
        protected void onPostExecute(Boolean result) {
            dialog.cancel();
            adapter = new RecyclerViewAdapter(FoodActivityV2.this,placesList);

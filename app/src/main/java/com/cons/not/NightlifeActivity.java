...
public class NightlifeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new JSONAsyncTask().execute("https://api.myjson.com/bins/bgp8v");
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(NightlifeActivity.this);
        ...
        protected void onPostExecute(Boolean result) {
            dialog.cancel();
            adapter = new RecyclerViewAdapter(NightlifeActivity.this,placesList);
